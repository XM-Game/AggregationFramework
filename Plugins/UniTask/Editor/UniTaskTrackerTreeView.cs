...
namespace Cysharp.Threading.Tasks.Editor
{
    ...
    /// </summary>
    /// <remarks>
    /// 继承自 TreeViewItem，用于在任务跟踪器视图中显示任务信息
    /// </remarks>
    ...
    public class UniTaskTrackerTreeView : TreeView
    {
        ...
        public UniTaskTrackerTreeView()
            ...
            {
                new MultiColumnHeaderState.Column() { headerContent = new GUIContent("任务类型 TaskType"), width = 20},
                new MultiColumnHeaderState.Column() { headerContent = new GUIContent("耗时 Elapsed"), width = 10},
                new MultiColumnHeaderState.Column() { headerContent = new GUIContent("状态 Status"), width = 10},
                new MultiColumnHeaderState.Column() { headerContent = new GUIContent("位置 Position")},
            })))
        {
        }
