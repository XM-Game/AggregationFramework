...
#endif
{
    ...
    /// </summary>
    /// <param name="writer">缓冲区写入器</param>
    /// <param name="firstBufferOfWriter">第一个缓冲区</param>
    /// <param name="optionalState">可选状态</param>
    ...
    /// 写入UTF8字符串
    /// </summary>
    /// <param name="utf8Value">UTF8字符串</param>
    /// <param name="utf16Length">UTF16长度</param>
    /// <returns>void</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// 写入值
    /// </summary>
    /// <typeparam name="TFormatter">类型</typeparam>
    /// <typeparam name="T">类型</param>
